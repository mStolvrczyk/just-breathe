<template>
  ...
  >
    <div id="chart-dialog-card">
      ...
      <transition name="popup">
        <div v-if="measurementsStatement">
          ...
          <line-chart
            ...
            :height.sync="chartHeight"
          />
          <div class="row chart-dialog action">
      ...
      <div class="row chart-dialog" v-if="measurementsStatement">
        <div class="row chart-dialog">
      ...
      <div class="row chart-dialog action button">
